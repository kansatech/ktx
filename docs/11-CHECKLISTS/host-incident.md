# Host Incident Checklist

- [ ] Preserve provider console/admin path
- [ ] Contain public ingress if needed
- [ ] Preserve logs/config/state/evidence
- [ ] Determine whether root/Docker/kernel control was obtained
